---
title: "mfinn13_FinalHomeworkCode_03"
...
#height
paste("The mean height is ", mean(zombies$height), sep = "")
paste("Ehe standard deviation for height is ", pop_SD(zombies$height), sep = "")

#weight
paste("The mean weight is ", mean(zombies$weight), sep = "")
paste("Ehe standard deviation for weight is ", pop_SD(zombies$weight), sep = "")

#age
paste("The mean age is ", mean(zombies$age), sep = "")
paste("Ehe standard deviation for age is ", pop_SD(zombies$age), sep = "")

#number of zombies killed
paste("The mean zombies killed is ", mean(zombies$zombies_killed), sep = "")
paste("Ehe standard deviation for zombies killed is ", pop_SD(zombies$zombies_killed), sep = "")

#years of education
paste("The mean years of education is ", mean(zombies$years_of_education), sep = "")
paste("Ehe standard deviation for years of education is ", pop_SD(zombies$years_of_education), sep = "")
...
#Note from matteo: this works but if I had to do this again I would create a set of 100 samples first instead of creating a new one each time.
...
# Alexandra Comments
I also had a hard time with the sample function. I think we used replacement when bootstrapping to make sure that we do not end up doing a permutation, which is what I believe happens when we bootstrap without replacement. Besides what you mentioned in your fifth bullet point, you could maybe use a plot from ggplot or a histogram to physically see the distribution, so you can see what visualization fits best and match the distribution to the dataset. Honestly, I just used trial and error to do mine. 